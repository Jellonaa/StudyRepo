...
#include <memory>
#include "../../vk6_kt_alkua/myclass.h"
...
QT_MOC_LITERAL(1, 8, 15), // "sendTimerUpdate"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 13), // "handleTimeOut"
QT_MOC_LITERAL(4, 39, 11), // "handleReset"
QT_MOC_LITERAL(5, 51, 12) // "handleSignal"

    },
    "myClass\0sendTimerUpdate\0\0handleTimeOut\0"
    "handleReset\0handleSignal"
};
...
void myClass::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sendTimerUpdate(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myClass::sendTimerUpdate)) {
                *result = 0;
                return;
            }
        }
